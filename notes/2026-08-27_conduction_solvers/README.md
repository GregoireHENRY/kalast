...
Moved to **`notes/2026-08-31_gis3d_tiri_product/`**. Building the TIRI data
product was a separate task from implementing the solvers, and it does not
belong in this note.
...
Moved to **`notes/2026-08-31_view_factors/`**. It grew from a review of
`view_factor_facets` into its own piece of work -- a GPU hemicube, radiative
heating in the TPM, four bugs and a shape-model correction -- and does not
belong inside a note about conduction solvers.
