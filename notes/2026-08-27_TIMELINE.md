...
Write-ups: `2026-08-27_pcf_shadow_comparison/`, `2026-08-27_renderer_auto_fit_wireframe/`,
`2026-08-27_CONFIG_options.md`, `2026-08-27_BENCH_mesh_resolution_results.md`.
...
- **`5dcc66f`** Full report with renders and figures:
  `2026-08-27_shadow_mesh_comparison/`. **~1.5x for 9 differing pixels of 1,040,400** in
...
- **`cb1b7da`** A compute pass reads the shadow map back *per facet*, giving
  ...
  ~36 days for the brute-force trace. Write-up: `2026-08-27_facet_shadow_query/`.
...
- **The largest remaining approximation is not numerical.** The Sun is treated
  ...
  consistent. See `2026-08-27_facet_shadow_query/` §7.
...
- **Solar penumbra** (`2026-08-27_facet_shadow_query/` §7) — the largest remaining
