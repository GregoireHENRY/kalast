...
path = Path("out")
dates = numpy.load(path / "dates.npy")
et_dates = numpy.load(path / "et.npy")
ps_dates = numpy.load(path / "ps.npy")
ds_dates = numpy.load(path / "ds.npy")

# date_start = "1989-02-01 00:00"
# date_start_export = "1989-03-01 00:00"
# date_stop = "1989-04-01 00:00"

date_start = "1988-11-01 00:00"
date_start_export = "1989-03-16 00:00"
date_stop = "1989-03-18 00:00"
...
# Surface.
body.surf.mesh = trimesh.load("moon.obj")
...
numpy.save(path_out / "et_simu.npy", et)
numpy.save(path_out / "z.npy", z)
numpy.save(path_out / "sun.npy", sun_save)
numpy.save(path_out / "tmp_surf.npy", tmp_surf_save)
numpy.save(path_out / "tmp_cols.npy", tmp_cols_save)
numpy.save(path_out / "tmp_state.npy", tmp_state_save)
